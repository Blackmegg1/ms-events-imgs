...
// 导入新的电极处理工具函数
import { handleSpecialElectrodeSelect, handleDeleteSpecialElectrodes } from './utils/electrodeHelpers';
...
const HomePage: React.FC = () => {
  ...
  // 修改特殊电极选择处理函数
  const handleSpecialElectrodeSelectWrapper = (index: number, checked: boolean) => {
