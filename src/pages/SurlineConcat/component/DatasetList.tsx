...
import { Button, Typography, Space, List, Checkbox, Tag, Card, Modal, message } from 'antd';
        ...
        renderItem={item => (
          <List.Item
            ...
            actions={[
              ...
              <Button key="view" type="link" onClick={() => onDatasetSelect(item.id)}>查看</Button>,
              <Button key="delete" type="link" danger onClick={() => onDatasetDelete(item.id)}><DeleteOutlined /></Button>
            ]}
            style={{ 
          ...
          >
            <Checkbox
              ...
              onChange={(e) => onDatasetCheckboxChange(item.id, e.target.checked)}
